...
?>
			...
			<div id="loginDiv">
				<form id="formIdentite" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>">
					<fieldset>
				...
				<form id="formInfosCredits" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>">
					<fieldset>
						...
						<ul>
							...
							<li><span>Mode de paiement : </span>
								<ul>
									<li><input id="mpCC_Visa" name="modePaiement" type="radio" value="cc_visa" checked="checked" /><label for="mpCC_Visa"><img src="images/paiement/visa-curved-32px.png" alt="icone carte de crédit Visa" /></label></li>
									<li><input id="mpCC_MasterC" name="modePaiement" type="radio" value="cc_mastercard" /><label for="mpCC_MasterC"><img src="images/paiement/mastercard-curved-32px.png" alt="icone carte de crédit MasterCard" /></label></li>
									<li><input id="mpCC_Discover" name="modePaiement" type="radio" value="cc_discover" /><label for="mpCC_Discover"><img src="images/paiement/discover-curved-32px.png" alt="icone carte de crédit discover" /></label></li>
				...
				<form id="formMDP" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>" autocomplete="off">
					<fieldset>
				...
				<form id="formInterets" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>">
					<fieldset>
				...
				<form id="formCommentaires" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>" autocomplete="off">
					<fieldset>
