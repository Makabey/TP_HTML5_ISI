				...
				<form id="formIdentite" method="POST" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
					<fieldset>
						...
						<dl>
							...
							--><dd><input type="text" disabled="disabled" value="<?php echo $_SESSION['user']; ?>" /></dd>
							...
							--><dd><label for="genreF"><input id="genreF" name="genre" type="radio" value="femme" />Une femme</label>
									<label for="genreH"><input id="genreH" name="genre" type="radio" value="homme" />Un homme</label>
									<label for="genreA"><input id="genreA" name="genre" type="radio" value="secret" checked="checked" />Secret</label></dd>
						</dl>
				...
				<form id="formCommentaires" method="POST" action="<?php echo $_SERVER['SCRIPT_NAME'];?>" autocomplete="off">
					<fieldset>
						...
						<dl>
							...
							--><dd><select id="choixSujet" name="choixSujet">
							...
							--><dd><textarea id="commentaire" name="commentaire" placeholder="Laissez-nous un message d'au plus 1024 caractères" title="Laissez-nous un message d'au plus 1024 caractères" required="required"></textarea></dd>
						</dl>
