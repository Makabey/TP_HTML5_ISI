...
?>
				<div class="aProposBox">
					...
					<div class="aProposBox_Content roundedCorners_bottom">
						<img src="assets/images/apropos_img1.jpg" alt="Menuiserie1" title="Menuiserie1" class="floatLeft" />
				...
				<div class="aProposBox">
					...
					<div class="aProposBox_Content roundedCorners_bottom">
						<img src="assets/images/apropos_img2.jpg" alt="Menuiserie2" title="Menuiserie2" class="floatRight" />
				...
				<div class="aProposBox">
					...
					<div class="aProposBox_Content roundedCorners_bottom">
						<img src="assets/images/apropos_img3.jpg" alt="Menuiserie3" title="Menuiserie3" class="floatLeft" />
