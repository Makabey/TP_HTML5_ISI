<?php
$sPageTitle = "La Fabrique de Jouet - Contactez-nous";

require_once "assets/inc/csvFunctions.inc.php";
require_once "assets/inc/header.inc.php";

// function pour éliminer les characete spéciaux
...
?>
			<div id="loginDiv">
				...
				<form id="formLogin" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="formulaire">
				...
				<form id="formRegister" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="formulaire">
