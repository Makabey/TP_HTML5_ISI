...
if($retour === false){
	...
	/*
		...
		question sécuritée, c'est de la bouette parce que cette même page est utilisée par les admins, sinon pour illustration, ça va!
	*/
...
?>
					<h1><?=($client_ID == -1)?"Factures des clients":"Mes Factures"?></h1>
					<table>
						<tr>
							<th>No Facture</th>
							<th>Date d'achat</th>
