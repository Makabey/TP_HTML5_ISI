window.addEventListener("load", function(){
	...
	$("#apropos #content section>div>div:first-child>div>div").click(function(){
		...
		if(true === geoON){
			$(baliseDeGeolocalisation).html("<p>Localisation en cours...<img src='images/wait_circle2.png' class='waitCircle' alt='attendez...' /></p>");
	...
	function show_map(position) {
		...
		$(baliseDeGeolocalisation).html("<p>Localisation réussie!</p><p>Estimation de la distance...<img src='images/wait_circle2.png' class='waitCircle' alt='attendez...' /></p>");
		read_mapDistance();
	}
	...
	function read_mapDistance(){
		var xhr = getXhr();
		var urlAuthentify="xhr/apropos.xhr.php";
		var queryString;
		...
		xhr.onreadystatechange = function(){
			...
			if(xhr.readyState == 4 && xhr.status == 200){
				...
				if(xhrAnswer_MapDistance['status'] == 'OK'){
					$(baliseDeGeolocalisation).html("<p>Localisation réussie!</p><p>Distance estimée à " + xhrAnswer_MapDistance.rows[0].elements[0].distance.text + "</p><p>Récupération de l'itinéraire...<img src='images/wait_circle2.png' class='waitCircle' alt='attendez...' /></p>");
					read_mapDirections();
				}else{
					$(baliseDeGeolocalisation).html("<p>Localisation réussie!</p><p>La récupération de la distance as échouée.<img src='images/wait_circle2.png' class='waitCircle' alt='attendez...' /></p>");
				}
			}
		}
