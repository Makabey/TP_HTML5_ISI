...
?>
			...
			<div id="loginDiv">
				...
				<form id="formLogin" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>">
					...
					<fieldset>
						<button class="btn submit auth" type="submit" id="connecter">Connexion</button>
					</fieldset>
				</form><!-- FIN formulaire login -->

				<!-- DÉBUT formulaire inscription -->
				<form id="formRegister" method="POST" action="<?=$_SERVER['SCRIPT_NAME']?>" autocomplete ="off">
					...
					<fieldset>
						<button class="btn submit auth" type="submit" id="register">Envoyer</button>
					</fieldset>
